...
[Unity](https://www.throwtheswitch.org/unity) 테스트 프레임워크와 [Ceedling](https://www.throwtheswitch.org/ceedling)을 사용해 펌웨어 로직을 단위 테스트로 검증합니다.
...
1. STM32CubeIDE에서 `lora_tester_stm32/` 프로젝트를 import
2. STM32F746G-DISCO 보드를 연결
3. Build 후 보드에 플래시
